...
public class LoginController implements Controller {
    ...
    private void goToForgotPassword() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/product_management/ForgetPassword.fxml"));
            Parent root = loader.load();
            ...
            popupStage.setTitle("Product Management: Reset Password");
