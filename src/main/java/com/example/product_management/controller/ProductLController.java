...
public class ProductLController {
    ...
    @FXML
    private TableView<ProductList> viewStock;

    @FXML
    private TableColumn<ProductList, Integer> idColumn;

    @FXML
    private TableColumn<ProductList, Integer> productIdColumn;

    @FXML
    private TableColumn<ProductList, String> nameColumn;

    @FXML
    private TableColumn<ProductList, Integer> quantityColumn;

    @FXML
    private TableColumn<ProductList, String> dateColumn;

    private final ObservableList<ProductList> stockEntries = FXCollections.observableArrayList();
